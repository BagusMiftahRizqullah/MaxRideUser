...
import {WelcomeImg, Logo, LogoWhite, ThumbsUp} from '@assets';
        ...
        <VStack style={[styles.card, styles.bgLayout]}>
          ...
          <VStack style={styles.logoParent}>
            ...
            <View style={styles.mobileNumberParent}>
              <Text style={styles.mobileNumber}>Account Created!</Text>
              <Text style={[styles.pleaseEnterYour, styles.byContinueYouTypo]}>
                Enter Your account has been created successfully. Press continue
                to start using app.
              </Text>
            </View>
          </VStack>
...
const styles = StyleSheet.create({
  ...
  capacityLayout: {
    height: CustomSpacing(112),
    width: CustomSpacing(112),
    position: 'absolute',
  },
  byContinueYouTypo: {
