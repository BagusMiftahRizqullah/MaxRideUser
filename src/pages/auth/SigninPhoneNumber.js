  ...
  return (
    <VStack style={styles.loginWithMobile}>
      <ScrollView style={styles.content}>
          ...
          <VStack style={styles.logoParent}>
            ...
            <View style={styles.mobileNumberParent}>
              ...
              <Text style={[styles.pleaseEnterYour, styles.byContinueYouTypo]}>
                Please enter your phone number. We will send you 4-digit code to
                verify your account.
              </Text>
            </View>
          </VStack>
        ...
        <VStack style={styles.inputConten}>
          <HStack style={{justifyContent: 'flex-start'}}>
            <VStack>
              ...
              <Text style={[styles.labelCaption1, styles.labelTypo]}>
                Country
              </Text>
              <Spacer height={CustomSpacing(4)} />
              <VStack
                style={{
                  marginHorizontal: CustomSpacing(12),
                  borderWidth: 2,
                  borderRadius: 8,
                  borderColor: CountryCode.length > 0 ? 'green' : 'grey',
                  width: CustomSpacing(100),
                }}>
                <TextInput
                  value={CountryCode}
                  style={{color: '#000000'}}
                  onChangeText={handleChangeConuntryCode}
                />
              </VStack>
            </VStack>
            {/* <Spacer width={12} /> */}
            <VStack>
              ...
              <VStack
                style={{
                  borderWidth: 2,
                  borderRadius: 8,
                  borderColor: phoneNumber.length > 0 ? 'green' : 'grey',
                  width: dimensions.screenWidth - CustomSpacing(150),
                }}>
                <TextInput
                  value={phoneNumber}
                  style={{color: '#000000'}}
        ...
        <VStack style={{paddingTop: CustomSpacing(32), alignItems: 'center'}}>
          <TouchableOpacity
            onPress={() => navigation.navigate('SigninPinVerif')}>
            <FastImage
              source={Logo}
